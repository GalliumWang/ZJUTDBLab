...
/**
 * Servlet implementation class zrh
 */
@WebServlet("/zrh.do")
public class zrh extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!p1.equals(p2)) {
			...
			else out.println("<script> alert(\"修改失败，请重试\");window.location.href='signup2.jsp' </script>");
		}
		}
		else out.println("<script> alert(\"密码错误\");window.location.href='signup2.jsp' </script>");
	}
