 ...
 * Generated at: 2020-07-07 15:27:52 UTC
...
public final class signup3_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<h4>开课</h4>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<form action=\"cse.do\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-body\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"help-block\">请输入课程号</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"inputName\" placeholder=\"课程号\" required name=\"cno\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group has-feedback\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"help-block\">请输入课程名</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"inputEmail\" placeholder=\"课程名\"  required name=\"cname\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"help-block\">请输入学分</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  <input type=\"text\"   id=\"inputPassword\" placeholder=\"学分\" pattern=\"^[0-9]+.?[0-9]*$\" required name=\"credit\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"help-block\">请输入学时</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  <input type=\"text\"  id=\"inputPassword\" placeholder=\"学时\" pattern=\"^[0-9]+.?[0-9]*$\" required name=\"time\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"help-block\">请输入开课时间</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  <input type=\"text\"   id=\"inputPassword\" placeholder=\"开课时间\" pattern=\"^20[1-2][0-9][上,下]$\" required name=\"xq\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"radio\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t  <input type=\"radio\" name=\"type\" value=\"1\" checked>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t  考试\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"radio\">\r\n");
      ...
      out.write("\t\t   <p>谢谢使用 &nbsp;&nbsp;&nbsp;如有问题&nbsp;&nbsp;&nbsp;欢迎来电咨询 &nbsp;&nbsp;&nbsp;咨询电话：178******66&nbsp;&nbsp;&nbsp;最终解释权归py所有</p>\r\n");
      out.write("\t   </div>\r\n");
      out.write("        <!--//footer-->\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
